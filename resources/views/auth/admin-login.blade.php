...
@section('title', 'Login Admin - BPS Magang')
...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-2">Login Admin/Mentor</h2>
            <p class="text-gray-600">Masuk ke panel administrasi BPS Magang</p>
        </div>
        ...
        <div class="bg-white py-8 px-6 shadow-lg rounded-lg border border-gray-200">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            value="{{ old('email') }}"
                            required
                            class="appearance-none relative block w-full px-10 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm @error('email') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            required
                            class="appearance-none relative block w-full px-10 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm @error('password') border-red-300 @enderror"
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Anda peserta magang?
                    <a href="{{ route('magang.login') }}" class="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-200">
